export default async () => {
  return await Promise.resolve({
    ...
    content: {
      ...
      aboutUs: {
        title: 'About us',
        metaDesrciption: 'In colombiabonita we offer four extraordinary places, simple, but with all the comforts, where you can enjoy with your family or friends the natural beauty of Colombia.',
      ...
      destinations: {
        ...
        covenas: {
          title: 'Coveñas',
          metaDesrciption: 'Coveñas. A simple cabin two minutes from the beach.',
        ...
        pradolu: {
          ...
          metaDesrciption: 'Prado. The Lucerna farm offers ...',
        ...
        pradonat: {
          ...
          metaDesrciption: 'Prado. The Natalie farm offers ...',
        ...
        stamarta: {
          title: 'Santa Marta',
          metaDesrciption: 'The flat in Santa Marta...',
      ...
      gallery: {
        covenas: {
          ...
          metaDesrciption: 'Image gallery of the cabin in Coveñas',
          gallery: {
        ...
        pradolu: {
          ...
          metaDesrciption: 'Image gallery of...',
          gallery: {
            altP1: 'Description image 1',
            altP2: 'Description image 2',
            altP3: 'Description image 3',
