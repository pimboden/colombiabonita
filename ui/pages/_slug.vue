...
export default {
  ...
  asyncData(context) {
    ...
    let fullSlug =
      ...
      || context.route.path == '/en/' || context.route.path == '/es/' || context.route.path == '/de/'
      || context.route.path == '/en' || context.route.path == '/es' || context.route.path == '/de'
        ? '/home'
        : context.route.path

    if(context.route.params.slug && context.route.params.slug !==''){
      fullSlug = '/'+context.route.params.slug
    }
